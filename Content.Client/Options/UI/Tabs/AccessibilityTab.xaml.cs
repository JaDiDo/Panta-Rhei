...
public sealed partial class AccessibilityTab : Control
{
    public AccessibilityTab()
    {
        ...
        Control.AddOptionCheckBox(FloofCCVars.GreyNightVision, GreyNightVisionCheckBox);

        Control.AddOptionCheckBox(CCVars.AccessibilityClientCensorNudity, CensorNudityCheckBox);
        // Floofstation section
        Control.AddOptionCheckBox(FloofCCVars.AccessibilityFullLanguageNames, FullLanguageNamesCheckBox);
