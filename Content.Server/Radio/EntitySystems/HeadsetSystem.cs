...
public sealed class HeadsetSystem : SharedHeadsetSystem
{
    ...
    private void OnHeadsetReceive(EntityUid uid, HeadsetComponent component, ref RadioReceiveEvent argsRaw)
    {
        ...
        var args = _radio.ApplyLanguageUnderstanding(argsRaw, parent); // Floofstation - languages
